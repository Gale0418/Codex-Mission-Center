...
| MC-037 | Lean Context and Execution Continuity | Epic |  | P0 | In Progress | Codex | MC-036 | 完成整合審查、CodeRabbit、Critic 與發布證據 | 全量測試、doctor、benchmark、publish verify | 8 | memory, continuity, v0.3 | 第三版為主規格；第二版補 Critical Lessons |
...
| MC-043 | Review and Packaging Contract Hardening | Task | MC-037 | P0 | In Progress | Codex | MC-038, MC-039, MC-040, MC-041, MC-042 | 執行 CodeRabbit、Critic、本機發布與 GitHub 流程 | full tests、CodeRabbit、critic、publish verify | 3 | review, packaging, release, p0 | Runtime requirements 必須進安裝產物 |
